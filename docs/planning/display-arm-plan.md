...
## Milestone 16 — the design, adopted ⬜
...
**What this milestone is not.** The page contains a notification centre, a quick-settings panel
...
is in the design and would be welcome, but it is a surface of its own and this milestone is about
...
metric in this milestone is written twice.** They go in the theme; the toolkit reads the theme;
