...
| — Administration | [administration.md](administration.md) | in progress — seven parts (A–G); **Part A complete 2026-09-23** (views, the broker and `with`); **Part B detailed 2026-09-23** (the device manager); **B.1 built 2026-09-24** (`/dev/registry`), **B.2 2026-09-24** (`device-mgr`) |
