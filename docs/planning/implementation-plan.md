...
| — Administration | [administration.md](administration.md) | scoped 2026-09-22, not started — seven parts (A–G); Part A in progress: A.1 (`sys_ns_derive`) done 2026-09-23, A.2 (a terminal per stage) next |
