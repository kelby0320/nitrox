...
| — Administration | [administration.md](administration.md) | in progress — seven parts (A–G); **Part A complete 2026-09-23** (views, the broker and `with`); Part B's detail pass next |
