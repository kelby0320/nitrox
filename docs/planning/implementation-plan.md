...
| — Administration | [administration.md](administration.md) | scoped 2026-09-22, not started — seven parts (A–G); Part A in progress: A.1 (`sys_ns_derive`) and A.2 (a terminal per stage) done 2026-09-23, A.3 (the broker) next |
