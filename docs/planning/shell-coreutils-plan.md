...
- **Design (UI composition, upstream where they touch):** `docs/architecture/ui-composition-model.md`
...
`docs/architecture/ui-composition-model.md` (for `form`/stdout only) → `docs/spec/typed-stream-format.md`
