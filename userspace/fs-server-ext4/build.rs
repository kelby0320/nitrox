...
//!
//! Unlike the other userspace bins, fs-server-ext4 is also a **library** with host unit
//! tests (`cargo test -p fs-server-ext4 --lib`). The fixed-address bare-target script must
